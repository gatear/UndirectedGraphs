...
/**
 *  The {@code StreamIn} class provides static methods for reading strings
 ...
 *  <pre>
 *  while (!StreamIn.isEmpty()) {
 *      double value = StreamIn.readDouble();
 *      StreamOut.println(value);
 *  }
 *  StreamOut.println(sum);
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (StreamIn.hasNextChar()) {
 *      char c = StreamIn.readChar();
 *      StreamOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = StreamIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code StreamIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code StreamIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code StreamIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code StreamIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code StreamIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StreamOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code StreamIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code StreamIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code StreamIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code StreamIn}
...
public final class StreamIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to StreamIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to StreamIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to StreamIn,
    ...
    //// end: section (2 of 2) of code duplicated from In to StreamIn


    // do this once when StreamIn is initialized
    static {
        resync();
    }

    /**
     * If StreamIn changes, use this to reinitialize the scanner.
     */
    ...
    private static void setScanner(Scanner scanner) {
        StreamIn.scanner = scanner;
        StreamIn.scanner.useLocale(LOCALE);
    }
